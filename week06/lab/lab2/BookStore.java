...
public class BookStore {
    private static DecimalFormat decimalFormats = new DecimalFormat("0.00");
    ...
    public static void bill(Order o) { 
        if ( o.discount() != 0.0 ){
            System.out.println(o.customers() + " has got a discount of " + decimalFormats.format(o.calculateDiscountAmount()) + " Baht and must pay " + decimalFormats.format(o.calculateFinalPrice()) + " Baht.");
        }else{
            System.out.println(o.customers() + " must pay " + decimalFormats.format(o.calculateFinalPrice()) + " Baht.");
        }
        System.out.println("");
    }
}